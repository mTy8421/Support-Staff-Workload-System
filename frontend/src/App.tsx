...
import GeneralAdministration from "./pages/dean/generaladministration";
import Academic from "./pages/dean/academic";
import Plan from "./pages/dean/plan";
import DevelopDigitalSkills from "./pages/dean/developdigitalskills";
