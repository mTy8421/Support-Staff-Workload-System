            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
              <div className="px-6 py-4 border-b border-gray-100 flex justify-between items-center bg-gray-50">
                ...
                <button
                  ...
                  className="text-sm text-blue-600 font-medium hover:underline bg-transparent border-none cursor-pointer"
                >
                  ดูทั้งหมด
                </button>
              </div>
                ...
                <table className="w-full text-left border-collapse">
                  <thead>
                    <tr className="text-sm text-gray-500 border-b border-gray-100">
                      ...
                      <th className="px-6 py-3 font-medium text-right bg-white whitespace-nowrap">
                        เวลาที่ใช้ (ชม : นาที)
                      </th>
                      <th className="px-6 py-3 font-medium text-right bg-white whitespace-nowrap">
                        รวมนาที
                    ...
                    {metrics.completedTasks.map((task) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <td className="px-6 py-4 text-right font-mono text-gray-600 whitespace-nowrap">
